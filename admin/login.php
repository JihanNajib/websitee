<?php
// Pastikan session dimulai untuk mengakses $_SESSION
session_start();
                                    ...
                                    <div class="card-body">
                                        <form method="post" action="function.php">
                                            ...
                                            if (isset($_GET['error']) && $_GET['error'] == '1') {
                                                echo "<div class='text-danger mt-3 text-center'>Email atau password salah!</div>";
                                            }
                                            if (isset($_GET['timeout']) && $_GET['timeout'] == '1') {
                                                echo "<div class='text-warning mt-3 text-center'>Sesi Anda telah berakhir, silakan login kembali.</div>";
                                            }
                                            ?>
                                        </form>
                                    </div>
